...
****
***************
  March 22, 2021 Added Thermistor
...
*Integers
  ...
  13-14 Temperature C
  15-16 Temperature F
  17-18 Temperature Thermistor on A1
*/
...
enum {
  ...
  TempFHB,    //16  FloatB
  TempTLB,  //17  FloatA Modicon Thermistor 
  TemoTHB,  //18  FloatB 
  TOTAL_ERRORS,//19
  // leave this one
  TOTAL_REGS_SIZE//20
...
void loop() {
 ...
 float tempT = thermistor.read();   // Read temperature
//  m_3 = analogRead(1);
// m_3 = analogRead(1);
...
float_number= tempT/10;
  ...
  unsigned int reg4 = f_2uint_int1(float_number);           // split the float into 2 unsigned integers
  unsigned int reg5 = f_2uint_int2(float_number);
  holdingRegs[17] = reg4;
  holdingRegs[18] = reg5;
  //******************
